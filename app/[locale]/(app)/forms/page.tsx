  ...
  return (
    <main className="p-6 pb-24 max-w-md mx-auto min-h-screen bg-white">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* טופס 1 */}
        <Link href="/forms/child-registration-request" className="bg-orange-300 p-6 rounded-2xl shadow-sm text-right hover:opacity-90 transition-opacity">
          <h2 className="text-xl font-bold text-orange-900 mb-2">{t('forms.childRegistrationRequest.title')}</h2>
        </Link>
